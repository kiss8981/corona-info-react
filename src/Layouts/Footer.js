...
const Footer = () => {
    return (
        <footer className="footer bg-current relative pt-1 border-b-2 border-blue-700" style={{backgroundColor: "#36393f"}}>
            <Container>
                ...
                <div className="sm:flex sm:mt-8">
                    <div className="mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row justify-between">
                        <div className="flex flex-col">
                            ...
                            <span className="my-2"><a href="/coronainfo" className="text-white text-md hover:text-blue-500">확진자 정보</a></span>
